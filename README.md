...
As part of a warmup to ROS2, we took on a series of mini-projects that allowed us to become familiar with ROSs structure. We also employed various algorithms to achieve the tasks, learning a lot along the way.
