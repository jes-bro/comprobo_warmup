...
Illustration of square driving pattern.
...
<div style="text-align:center">
    <img src="./media/3_1.svg" alt="Alt text" width="400">
</div> 
Case where we have to correct by turning away from the wall.
...
<div style="text-align:center">
    <img src="./media/3_2.svg" alt="Alt text" width="400">
</div> 
...
How the robot should orient itself in relation to the target.
<br/><br/>
